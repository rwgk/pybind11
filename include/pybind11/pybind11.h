...
protected:
    ...
    void initialize(Func &&f, Return (*)(Args...), const Extra &...extra) {
        ...
        rec->impl = [](function_call &call) -> handle {
            ...
            return_value_opts rvo = call.func.rvo;
            rvo.policy = return_value_policy_override<Return>::policy(rvo.policy);
            ...
            handle result = cast_out::cast(
                std::move(args_converter).template call<Return, Guard>(cap->f), rvo, call.parent);
